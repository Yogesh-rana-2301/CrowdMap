#  CrowdMap: Real-time Crowd Density Monitoring
...
**Trying to Prevent stampedes and ensuring public safety through AI-powered crowd monitoring**
...
> i am using `yolov8n.pt` i.e is the lightest and the fastest but is the least accurate. You could use `yolov8s.pt` or `yolov8m.pt`.
...
### �Future Roadmap
-  **Drone Integration** → Aerial crowd monitoring for large gatherings
-  **Mobile App** → Live crowd status before visiting locations
-  **Edge AI** → Raspberry Pi/Jetson Nano deployment for low-cost solutions
-  **Government Integration** → Smart city dashboards for authorities
...
I welcome contributions from developers, researchers, and civic innovators! 
...
** Special Note**: I encourage **governments and civic bodies worldwide** to use this project freely for public safety purposes.
...
-  **Issues**: [GitHub Issues](https://github.com/yogesh-rana-2301/CrowdMap/issues)
-  **Discussions**: [GitHub Discussions](https://github.com/yogesh-rana-2301/CrowdMap/discussions)
